...
- **[1 界面设计](#1 界面设计)**
  - **[1.1 StackView](#1.1 StackView)**
    - [1.1.1 主要约束](#1.1.1 主要约束)
    - [1.1.2 显示区域（View1）](#1.1.2 显示区域（View1）)
    - [1.1.3 按键区域（View2）](#1.1.3 按键区域（View2）)
      - [1.1.3.1. 常规按键区](#1.1.3.1. 常规按键区)
      - [1.1.3.2 附加按键区](#1.1.3.2 附加按键区)
      - [1.1.3.3 按钮细节](#1.1.3.3 按钮细节)
  - **[1.2. D/R Show Label](#1.2. D/R Show Label)**
- **[2 功能实现](#2 功能实现)**
  - **[2.1 基础功能](#2.1 基础功能)**
    - [2.1.1 用户输入处理](#2.1.1 用户输入处理)
    - [2.1.2 主要运算逻辑](#2.1.2 主要运算逻辑)
    - [2.1.3 memery 操作](#2.1.3 memery 操作)
    - [2.1.4 角度制与弧度制的切换](#2.1.4 角度制与弧度制的切换)
    - [2.1.5 按钮功能切换（函数与反函数之间的互换）](#2.1.5 按钮功能切换（函数与反函数之间的互换）)
    - [2.1.6 转动设备时的界面切换](#2.1.6 转动设备时的界面切换)
  - **[2.2 辅助功能](#2.2 辅助功能)**
    - [2.2.1 等于操作的作用](#2.2.1 等于操作的作用)
    - [2.2.2. 更好的删除操作](#2.2.2. 更好的删除操作)
    - [2.2.3 面向用户的报错机制](#2.2.3 面向用户的报错机制)
- **[3 问题与解决](#3 问题与解决)**
  - **[3.1 使 Stack View 中的空间按比例布局](#3.1 使 Stack View 中的空间按比例布局)**
  - **[3.2 Swift获取当前设备的状态](#3.2 Swift获取当前设备的状态)**
  - **[3.3 代码实现修改Button字体大小](#3.3 代码实现修改Button字体大小)**
  - **[3.4 设置圆形的Button](#3.4 设置圆形的Button)**
- **[4 成果展示](#4 成果展示)**
  - **[4.1 完整流程](#4.1 完整流程)**
  - **[4.2 压力测试（随便乱按）](#4.2 压力测试（随便乱按）)**
